...
from .routers import age_gate, app_feedback, badges, battles, challenges, learning_pauses, level_feedback, mentalcoins, movement, notifications, profile, progress, stats, subscription, ranking, social
