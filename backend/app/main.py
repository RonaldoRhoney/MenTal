...
from .routers import admin_metrics, age_gate, app_feedback, app_version, badges, battles, challenges, coach, concursos, content_suggestions, economy, feed, learning_pauses, level_feedback, mental_lingo, mentalcoins, movement, notifications, profile, progress, public_profile, stats, subscription, ranking, social, word_puzzles
...
app.include_router(concursos.router, tags=["concursos"])
app.include_router(mental_lingo.router, tags=["mental_lingo"])
