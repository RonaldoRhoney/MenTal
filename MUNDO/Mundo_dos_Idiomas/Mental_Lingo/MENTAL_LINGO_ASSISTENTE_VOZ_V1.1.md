...
- **Estado Ouvindo com timeout obrigatório (adição v1.1):** definir um tempo limite de silêncio (ex.: alguns segundos sem fala detectada) que transiciona automaticamente para Falha ou de volta a Pronto — evitando que a captura de voz fique presa indefinidamente aguardando o usuário.
...
- **Teste de timeout do estado Ouvindo (adição v1.1):** confirmar que o sistema não fica preso indefinidamente aguardando fala do usuário.
