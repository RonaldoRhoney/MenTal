...
- manteiga → **Butter** (erradas: Buttter, Buttre, Butder)
- mel → **Honey** (erradas: Heney, Honeyy, Hony)
- abacaxi → **Pineapple** (erradas: Pineapble, Pineappe, Pineopple)
...
## Lugares 2
- fazenda → **Farm** (erradas: Fram, Furm, Ffarm)
- biblioteca → **Library** (erradas: Librury, Librray, Librar)
- farmácia → **Pharmacy** (erradas: Pharrmacy, Pharmaky, Phharmacy)
- padaria → **Bakery** (erradas: Bikery, Bacery, Baery)
- esquina → **Corner** (erradas: Colner, Cerner, Conrer)
- prédio → **Building** (erradas: Buildeng, Bualding, Buylding)
- praça → **Square** (erradas: Squre, Squar, Squrae)
- portão → **Gate** (erradas: Gtae, Gaet, Gatte)
- torre → **Tower** (erradas: Towre, Towe, Towur)
- vila → **Village** (erradas: Vilalge, Villoge, Villaeg)

## Pessoas 2
- irmã → **Sister** (erradas: Sistr, Ssiter, Sisetr)
- pais → **Parents** (erradas: Purents, Palents, Porents)
- rei → **King** (erradas: Knig, Kinng, Kking)
- rainha → **Queen** (erradas: Quee, Qqueen, Quuen)
- pessoa → **Person** (erradas: Porson, Prson, Persan)
- pessoas → **People** (erradas: Peple, Peopli, Peopre)
- convidado → **Guest** (erradas: Gguest, Guesd, Guust)
- estranho → **Stranger** (erradas: Sstranger, Straner, Strunger)
- gêmeo → **Twin** (erradas: Tvin, Twun, Twyn)
- família → **Family** (erradas: Fmily, Fomily, Famiry)
...
- responder → **Answer** (erradas: Ansswer, Aswer, Answre)
- assistir → **Watch** (erradas: Wetch, Wotch, Watc)
...
- jovem → **Young** (erradas: Yuong, Yung, Yoing)
...
## Dias da semana
- segunda-feira → **Monday** (erradas: Mondey, Momday, Mondday)
- terça-feira → **Tuesday** (erradas: Tuesdey, Tuosday, Teusday)
- quarta-feira → **Wednesday** (erradas: Wednusday, Wednesdy, Wwednesday)
- quinta-feira → **Thursday** (erradas: Tthursday, Thhursday, Thursdoy)
- sexta-feira → **Friday** (erradas: Freday, Fryday, Frday)
- sábado → **Saturday** (erradas: Satrday, Saturdiy, Satudray)
- domingo → **Sunday** (erradas: Sundayy, Sundy, Sundya)
- fim de semana → **Weekend** (erradas: Wekeend, Weekedn, Wuekend)
- aniversário → **Birthday** (erradas: Bilthday, Birthdy, Bithday)
- feriado → **Holiday** (erradas: Holidey, Holidday, Holiady)

## Meses do ano
- janeiro → **January** (erradas: Janualy, Jamuary, Jnuary)
