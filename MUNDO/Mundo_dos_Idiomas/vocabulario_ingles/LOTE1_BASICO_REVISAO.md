...
- tio → **Uncle** (erradas: Unle, Uncre, Uncl)
- tia → **Aunt** (erradas: Autn, Aunnt, Anut)
- primo → **Cousin** (erradas: Coosin, Couson, Cousun)
- marido → **Husband** (erradas: Husbband, Husbannd, Husbant)
- esposa → **Wife** (erradas: Wefe, Wfie, Wiffe)
- bebê → **Baby** (erradas: Boby, Babi, Babyy)

## Corpo
- cabeça → **Head** (erradas: Haed, Heod, Heda)
- mão → **Hand** (erradas: Hhand, Hund, Hadn)
...
- amarelo → **Yellow** (erradas: Yelloww, Yerlow, Yellaw)
- preto → **Black** (erradas: Bleck, Brack, Blacck)
- branco → **White** (erradas: Wwhite, Whiti, Wihte)
- laranja → **Orange** (erradas: Oringe, Orango, Orage)
- rosa → **Pink** (erradas: Pinnk, Pank, Pnik)
...
- pato → **Duck** (erradas: Ducc, Dukc, Dack)

## Casa e objetos
- cadeira → **Chair** (erradas: Chaor, Chaar, Chaur)
- cama → **Bed** (erradas: Bedd, Bbed, Bde)
- cozinha → **Kitchen** (erradas: Kitchenn, Kytchen, Kitchin)
- banheiro → **Bathroom** (erradas: Bathhroom, Bahroom, Bathromo)
- chave → **Key** (erradas: Kkey, Kiy, Kye)
- telefone → **Phone** (erradas: Phine, Phona, Phome)
...
- amanhã → **Tomorrow** (erradas: Tomorruw, Tomorriw, Tomorrwo)
