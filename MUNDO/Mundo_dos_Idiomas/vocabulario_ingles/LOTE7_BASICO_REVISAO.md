...
## Ferramentas
- martelo → **Hammer** (erradas: Hamner, Hammur, Himmer)
- corda → **Rope** (erradas: Rupe, Ropo, Repe)
- escada de mão → **Ladder** (erradas: Laddre, Lader, Ladderr)
- balde → **Bucket** (erradas: Buckot, Buckte, Buckit)
- vassoura → **Broom** (erradas: Briom, Braom, Bbroom)
- agulha → **Needle** (erradas: Needlle, Neelde, Needdle)
...
- idoso → **Elderly** (erradas: Ellderly, Eldelry, Eldirly)
...
- rir → **Laugh** (erradas: Luugh, Lough, Laigh)
- chorar → **Cry** (erradas: Cly, Cyr, Ccry)
- gritar → **Shout** (erradas: Shuut, Shoat, Shotu)
- sussurrar → **Whisper** (erradas: Whusper, Whispr, Wisper)
- respirar → **Breathe** (erradas: Breethe, Bbreathe, Breithe)
...
- afiado → **Sharp** (erradas: Sarp, Shap, Shrp)
- liso → **Smooth** (erradas: Smouth, Ssmooth, Snooth)
...
## Números 2
- onze → **Eleven** (erradas: Elevenn, Elevne, Eloven)
- doze → **Twelve** (erradas: Twlve, Tweve, Tvelve)
- vinte → **Twenty** (erradas: Ttwenty, Twentty, Tweny)
- trinta → **Thirty** (erradas: Thity, Thilty, Thitry)
- quarenta → **Forty** (erradas: Foryt, Fforty, Fotry)
- cinquenta → **Fifty** (erradas: Fift, Fivty, Fifdy)
- sessenta → **Sixty** (erradas: Sixyt, Sixdy, Sxty)
- noventa → **Ninety** (erradas: Nonety, Nninety, Nynety)
- mil → **Thousand** (erradas: Thoisand, Thouasnd, Thhousand)
- milhão → **Million** (erradas: Milloin, Mollion, Millon)

## Palavras indefinidas
- por que → **Why** (erradas: Wwhy, Whi, Whyy)
- de quem → **Whose** (erradas: Whese, Whse, Whhose)
- algo → **Something** (erradas: Semething, Sometihng, Sumething)
- nada → **Nothing** (erradas: Nothign, Nathing, Nothnig)
- tudo → **Everything** (erradas: Evurything, Everythung, Eveything)
- todos → **Everyone** (erradas: Everyene, Eveyrone, Evveryone)
- alguém → **Someone** (erradas: Somone, Someene, Someome)
- ninguém → **Nobody** (erradas: Nobodyy, Nubody, Nibody)
- qualquer coisa → **Anything** (erradas: Anyhing, Anythinj, Anythong)
- em lugar nenhum → **Nowhere** (erradas: Nowere, Nowheer, Nwhere)

## Advérbios
- frequentemente → **Often** (erradas: Oftun, Oten, Oftten)
- geralmente → **Usually** (erradas: Uusally, Usally, Usualry)
- quase → **Almost** (erradas: Almot, Amost, Allmost)
- talvez → **Maybe** (erradas: Miybe, Mayb, Maybbe)
- realmente → **Really** (erradas: Rually, Realli, Realyl)
- juntos → **Together** (erradas: Toguther, Toether, Togither)
- rapidamente → **Quickly** (erradas: Quickl, Quackly, Quickry)
- devagar → **Slowly** (erradas: Slowwly, Slowli, Slewly)
- com cuidado → **Carefully** (erradas: Careully, Curefully, Carifully)
- de repente → **Suddenly** (erradas: Soddenly, Suddenyl, Suddenry)
