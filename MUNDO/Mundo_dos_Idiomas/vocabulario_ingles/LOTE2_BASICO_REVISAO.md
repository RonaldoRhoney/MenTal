...
## Cidade e lugares
- cidade → **City** (erradas: Cidy, Ccity, Cety)
- loja → **Store** (erradas: Storre, Stire, Stoe)
- mercado → **Market** (erradas: Markket, Markit, Murket)
- parque → **Park** (erradas: Pakr, Purk, Parkk)
- igreja → **Church** (erradas: Chulch, Chucrh, Churc)
- praia → **Beach** (erradas: Beich, Baach, Beahc)
...
- cozinheiro → **Cook** (erradas: Cookk, Cooc, Ciok)
- motorista → **Driver** (erradas: Druver, Drver, Drivr)
- vizinho → **Neighbor** (erradas: Neighbir, Neughbor, Neighborr)
- criança → **Child** (erradas: Chird, Chuld, Cild)

## Tecnologia e objetos
- computador → **Computer** (erradas: Combuter, Computor, Compiter)
- tela → **Screen** (erradas: Scrien, Sceen, Screun)
...
- sujo → **Dirty** (erradas: Dirtyy, Drity, Dirdy)
- leve → **Light** (erradas: Ligh, Loght, Lighht)
