...
- multidão → **Crowd** (erradas: Cowd, Cruwd, Criwd)
- centro da cidade → **Downtown** (erradas: Downtuwn, Dontown, Dowwntown)
- elevador → **Elevator** (erradas: Elevatro, Elevatr, Eleavtor)
- tribunal → **Court** (erradas: Courtt, Coirt, Cuurt)

## Verbos dos sentidos
- brilhar → **Shine** (erradas: Shime, Shie, Shune)
- soprar → **Blow** (erradas: Bllow, Blwo, Blaw)
- sacudir → **Shake** (erradas: Shhake, Shoke, Shaku)
- rolar → **Roll** (erradas: Rorl, Rolr, Rall)
- passar por → **Pass** (erradas: Pess, Pasz, Pazs)
- juntar-se → **Join** (erradas: Jein, Jion, Jjoin)
...
## Datas e quantidades
- diário → **Daily** (erradas: Dayly, Dily, Duily)
...
- tudo bem ok → **Okay** (erradas: Okiy, Okai, Okayy)
...
- fechadura → **Lock** (erradas: Llock, Lokc, Lcok)
- máscara → **Mask** (erradas: Misk, Massk, Maks)
- lanterna → **Flashlight** (erradas: Flashleght, Flshlight, Flazhlight)
- selo postal → **Stamp** (erradas: Stmp, Samp, Stammp)
- barraca de camping → **Tent** (erradas: Tunt, Temt, Tetn)
