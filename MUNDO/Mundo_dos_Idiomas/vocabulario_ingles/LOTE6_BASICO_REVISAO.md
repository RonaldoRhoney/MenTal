...
- coruja → **Owl** (erradas: Owwl, Olw, Ovl)
- papagaio → **Parrot** (erradas: Parrto, Purrot, Prarot)

## Saúde
- febre → **Fever** (erradas: Ffever, Fver, Fuver)
- tosse → **Cough** (erradas: Couggh, Coujh, Coug)
- remédio → **Medicine** (erradas: Meddicine, Medicene, Medocine)
...
- nervoso → **Nervous** (erradas: Nirvous, Nervius, Nevrous)
- tímido → **Shy** (erradas: Syh, Shhy, Shi)
- corajoso → **Brave** (erradas: Bravi, Braev, Brvae)
- preguiçoso → **Lazy** (erradas: Lzay, Lezy, Layz)
- esperto → **Clever** (erradas: Cleevr, Clefer, Clevel)
- educado → **Polite** (erradas: Pilite, Polit, Poite)
- ciumento → **Jealous** (erradas: Jaalous, Jeilous, Jealuus)
- animado → **Excited** (erradas: Exceted, Exctied, Excitet)
...
- entender → **Understand** (erradas: Understan, Understnd, Understtand)
...
- cesta → **Basket** (erradas: Bosket, Bazket, Basekt)
- carrinho de compras → **Cart** (erradas: Calt, Cirt, Catr)
...
- notícias → **News** (erradas: Newss, Nuws, Nevs)
- palavra → **Word** (erradas: Wordd, Wold, Werd)
- voz → **Voice** (erradas: Voie, Voace, Vocie)
- idioma → **Language** (erradas: Languaje, Langguage, Languoge)
- som → **Sound** (erradas: Seund, Soumd, Sund)
- canção → **Song** (erradas: Seng, Snog, Somg)

## Tempo 3
- minuto → **Minute** (erradas: Mimute, Miunte, Mniute)
