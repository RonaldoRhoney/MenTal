...
**Status:** Encerrada em 02/09/2026 — todos os 4 itens da ordem travada por Rhoney (abaixo) concluídos e em produção, incluindo o timing 20s universal do Relâmpago (`RELAMPAGO_TEMPO_20S_UNIVERSAL.md`) e a reorganização "Mundo da Descoberta" (`Mundo_da_Descoberta/PROMPT_CLAUDE_CODE_MUNDO_DESCOBERTA.md`). Ver `Mundo_dos_Idiomas/README.md` para o que vem a seguir.
...
- `Mundo_da_Descoberta/V4_NOVOS_TERRITORIOS.md` — cinco novos blocos de conteúdo (Invenções, Veículos, Ouvido Afiado, Detetive Mental, Astronomia), rollout sequencial igual ao usado na V3. Movido pra pasta do próprio Mundo em 06/09/2026, junto de `Mundo_da_Descoberta/PROMPT_CLAUDE_CODE_MUNDO_DESCOBERTA.md` (item abaixo).
...
4. ✅ **5 territórios novos** (Invenções, Veículos, Ouvido Afiado, Detetive Mental, Astronomia, `Mundo_da_Descoberta/V4_NOVOS_TERRITORIOS.md`) — concluído e em produção (02/09/2026), reorganizados em "Mundo da Descoberta" (`Mundo_da_Descoberta/PROMPT_CLAUDE_CODE_MUNDO_DESCOBERTA.md`).
