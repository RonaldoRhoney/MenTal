...
Escopo autorizado em `V2_KICKOFF.md`, após fechamento da V1.1. Cada
documento cobre um item específico do roadmap da V2 (Amigos, Disputa
territorial, Batalha assíncrona, Mundos, Movimento, etc.) — ver "item N
da V2" no cabeçalho de cada um.

- `V2_KICKOFF.md` — autorização e escopo geral da V2.
- `ASYNC_BATTLE.md` — item 14, batalha assíncrona.
